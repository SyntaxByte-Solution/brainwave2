...
const Contact = () => {
  const inputStyles =
    "block w-full rounded-md border border-[var(--color-border)] bg-[var(--color-card-background)] px-3.5 py-2.5 text-[var(--color-foreground)] shadow-sm outline-0 sm:text-sm sm:leading-6";
      ...
      <div className="isolate bg-white dark:bg-black px-6 py-16 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-3xl bg-secondary dark:bg-gray-900  p-6 sm:p-10 lg:p-16">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-[var(--color-foreground-muted)]">
                ...
                {[
                  {
                    ...
                    options: ["Select", "Web Design", "Web Development", "SEO"],
                  },
                  {
                    id: "budget",
